...
const services: Service[] = [
  {
    ...
    shortDesc: 'Быстрый ровный загар без перегрева и ощущения спешки.',
    fullDesc: 'Подходит тем, кто хочет красивый равномерный оттенок без лишнего дискомфорта. Мощный обдув, аква-бриз и современная система ламп делают сеанс комфортным даже в плотном графике дня.',
    image: 'https://picsum.photos/seed/vertical-tanning/800/1200',
    features: ['Ровный оттенок', 'Комфортный обдув', 'Аква-бриз', 'Быстрый сеанс'],
  },
  {
    id: 2,
    title: 'Горизонтальный солярий',
    shortDesc: 'Мягкий формат для тех, кто хочет расслабиться и спокойно загореть.',
    fullDesc: 'Идеален, если хочется не просто загара, а короткой паузы для себя. Удобная посадка, спокойный темп и приятное ощущение уюта во время всего сеанса.',
    image: 'https://picsum.photos/seed/horizontal-tanning/800/1200',
    features: ['Комфортное положение', 'Глубокий оттенок', 'Уютный формат', 'Расслабляющий сеанс'],
  },
  {
    id: 3,
    title: 'Коллагенарий',
    shortDesc: 'Деликатный уход для кожи, когда хочется свежести и более ровного тона.',
    fullDesc: 'Мягкий световой уход помогает коже выглядеть более гладкой, ухоженной и сияющей. Хороший выбор, если важен не только оттенок, но и общее впечатление от кожи после процедуры.',
    image: 'https://picsum.photos/seed/collagen/800/1200',
    features: ['Более свежий вид кожи', 'Мягкое сияние', 'Ровный тон', 'Деликатный anti-age уход'],
  },
  {
    id: 4,
    title: 'Косметика для загара',
    shortDesc: 'Подберём уход, чтобы загар ложился красивее и держался дольше.',
    fullDesc: 'Помогаем выбрать средство под тип кожи, желаемый оттенок и формат сеанса. Это делает результат более красивым, а кожу после загара, более мягкой и ухоженной.',
    image: 'https://picsum.photos/seed/tanning-cream/800/1200',
    features: ['Подбор под тип кожи', 'Усиление оттенка', 'Больше комфорта', 'Уход после сеанса'],
  },
];
    ...
    <section className="py-24 px-6 bg-ivory">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          ...
          >
            Не просто список услуг, а понятные форматы для красивого результата и комфортного визита.
          </motion.p>
        </div>
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <p className="text-white/70 text-sm font-light opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100 line-clamp-3">
                  {service.shortDesc}
                </p>
